...
function SignUp() {
  ...
  return (
    ...
    <div className='w-full h-screen relative flex justify-start items-center pl-24'>
      ...
      {/* Your Form (placed on top of the video) */}
      <form
        className='w-[90%] h-auto max-w-[500px] bg-[#00000062] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] p-[30px] rounded-lg'
      ...
      >
        ...
        <button
          className='min-w-[150px] h-[60px] mt-[30px] text-black font-semibold bg-white rounded-full text-[19px] disabled:opacity-50'
          disabled={loading}
        >

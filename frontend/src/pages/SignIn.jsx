...
import bg from "../assets/back.mp4"; // Your video import
...
function SignIn() {
  ...
  return (
    <div className='w-full h-screen relative flex justify-start items-center pl-24'>
        {/* Video Background */}
        <video
        ...
        {/* Your Form */}
        <form className='w-[90%] h-auto max-w-[500px] bg-[#00000062] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] p-[30px] rounded-lg' onSubmit={handleSignIn}>
            <h1 className='text-white text-[30px] font-semibold mb-[30px] text-center'>Sign In to <span className='text-blue-400'>Virtual Assistant</span></h1>
